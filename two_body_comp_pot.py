...
from  rmatrix_f2py_complex_potential  import rmat_ini,pot_output_rmatrix, gauleg 
import cmath 
...
class two_body_pot:
    ...
    def __init__(self, pot_func = lambda rvec: 0,  
        ...
        if compute_ps : 
            self.delta_re_mesh, self.delta_im_mesh, self.scatt_wf_in_re_mesh, self.scatt_wf_in_im_mesh  =  \
            ...
            self.delta_mesh=self.delta_re_mesh + 1j* self.delta_im_mesh
            self.scatt_wf_in_mesh=self.scatt_wf_in_re_mesh + 1j* self.scatt_wf_in_im_mesh 
